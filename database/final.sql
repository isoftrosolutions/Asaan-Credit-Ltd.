...
INSERT INTO `homepage_contents` (`id`, `key`, `value`, `created_at`, `updated_at`) VALUES (1,'hero_title','Connect with Investors. Sell or Grow Your Business Faster.',NULL,NULL),(2,'hero_subtitle','The premium marketplace where verified business owners meet qualified investors, buyers, and franchise partners. Close deals with confidence.',NULL,NULL),(3,'stats_businesses','67,500+',NULL,NULL),(4,'stats_investors','44,000+',NULL,NULL),(5,'stats_matches','12,800+',NULL,NULL),(6,'stats_deal_value','NPR 850 Cr+',NULL,NULL);
