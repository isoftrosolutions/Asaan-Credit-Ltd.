...
const DASHBOARD_LINKS = {
  ...
  owner: [
    { label: 'Dashboard', url: '/dashboard', icon: 'home' },
    { label: 'My Listing', url: '/business/dashboard', icon: 'briefcase' },
  ...
  entrepreneur: [
    { label: 'Dashboard', url: '/dashboard', icon: 'home' },
    { label: 'My Pitch', url: '/entrepreneur/dashboard', icon: 'chart' },
    { label: 'Connections', url: '/connections', icon: 'matches' },
    { label: 'Notifications', url: '/notifications', icon: 'bell' },
  ...
  franchisor: [
    { label: 'Dashboard', url: '/dashboard', icon: 'home' },
    { label: 'My Franchise', url: '/franchise/dashboard', icon: 'briefcase' },
    { label: 'Connections', url: '/connections', icon: 'matches' },
    { label: 'Notifications', url: '/notifications', icon: 'bell' },
