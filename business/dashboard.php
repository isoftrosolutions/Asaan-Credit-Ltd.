...
<p style="color:#666;">Manage your business listings and track performance.</p>
...
<div class="card" style="text-align:center;padding:3rem 2rem;margin-top:1.5rem;">
  ...
  <p style="color:#666;margin-bottom:1rem;">Create your first business listing to start connecting with investors and buyers.</p>
  ...
  <table style="width:100%;border-collapse:collapse;">
    ...
    <tr style="border-bottom:1px solid #eae8e6;">
      ...
      <td style="padding:14px 18px;text-align:center;">
        <?php if ($b['is_published']): ?><span style="color:#166534;font-weight:600;">Published</span>
