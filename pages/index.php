...
@media (max-width:767px) {
  .hp-why-img { border-radius:12px; margin-bottom:32px; }
}
    ...
    <div class="hp-hero-content">
      <div class="hp-hero-left">
        ...
        <div class="hp-hero-actions pub-cta-actions" style="justify-content:flex-start;margin-top:32px;">
          ...
          <?php endif; ?>
          <a href="https://www.youtube.com/@asaan.capital" target="_blank" rel="noopener" class="hp-hero-play" aria-label="YouTube channel" style="text-decoration:none;">
